...
public class UserService {
    ...
    public List<User> findBatchByUserIds(List<Long> userIds) {
        if (userIds == null || userIds.isEmpty()) {
            return new ArrayList<>();
        }
        return userRepository.findBatchByIds(userIds);
    }

    public void setAdmin(long targetUserId, boolean admin, long currentUserId) throws ValidationException {
        ...
        User targetUser = find(targetUserId);
        if (targetUser == null) {
            throw new ValidationException("User not found");
        }

        userRepository.setAdmin(targetUserId, admin);
    }
}